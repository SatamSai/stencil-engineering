    ...
    <>
      <section className="" id="contact">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 pt-12 border-t border-bg/[.18] px-5 md:px-8 py-[120px]" >
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-7 gap-x-6" onSubmit={e => { e.preventDefault(); setSubmitted(true); }}>
              <div className="flex flex-col gap-2">
                <label className=" text-[11px] tracking-[0.08em] uppercase text-bg/55" htmlFor="f-name">Name</label>
              ...
              <div className="flex flex-col gap-2">
                <label className=" text-[11px] tracking-[0.08em] uppercase text-bg/55" htmlFor="f-company">Company</label>
              ...
              <div className="flex flex-col gap-2">
                <label className=" text-[11px] tracking-[0.08em] uppercase text-bg/55" htmlFor="f-email">Email</label>
              ...
              <div className="flex flex-col gap-2">
                <label className=" text-[11px] tracking-[0.08em] uppercase text-bg/55" htmlFor="f-phone">Phone</label>
              ...
              <div className="flex flex-col gap-2 sm:col-span-2">
                <label className=" text-[11px] tracking-[0.08em] uppercase text-bg/55" htmlFor="f-sector">Sector / Type</label>
              ...
              <div className="flex flex-col gap-2 sm:col-span-2">
                <label className=" text-[11px] tracking-[0.08em] uppercase text-bg/55" htmlFor="f-msg">Brief</label>
              ...
              <button type="submit" className={`sm:col-span-2 mt-4 inline-flex items-center gap-4 px-8 py-4 text-sm font-medium tracking-[0.02em] rounded-full justify-self-start cursor-pointer transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-lg hover:opacity-90 active:scale-95 ${submitted ? "bg-bg-2 text-bg pointer-events-none" : "bg-bg-2 text-bg"}`}>
